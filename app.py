...
scaler = pickle.load(open(r'E:\onedrive\Desktop\Diabetes\diabetes-prediction\scaler.pkl', 'rb'))
model = pickle.load(open(r'E:\onedrive\Desktop\Diabetes\diabetes-prediction\svm_model.pkl', 'rb'))
